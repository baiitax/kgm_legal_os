-- ═══════════════════════════════════════════════════════════════════════════════
-- 0037 · THE AUDIT VOCABULARY GROWS WITH THE FEE  (P0.2 · P1)
-- ═══════════════════════════════════════════════════════════════════════════════
--
...
--
-- THE LIST IS GENERATED FROM THE UNION, IN ORDER, NOT TYPED. 120 actions.
-- ═══════════════════════════════════════════════════════════════════════════════
...
begin
  if not exists (
    ...
    raise exception '0037: audit_events_action_check was not created';
  end if;
  ...
  if admitted = 0 then
    raise exception '0037: the constraint does not look like an action list';
  end if;
  ...
  if missing is not null then
    raise exception '0037: declared but not admitted: %', missing;
  end if;

  raise notice '0037: audit vocabulary at 120 actions — verified against the declared union';
end $$;

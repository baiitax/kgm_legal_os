-- ═══════════════════════════════════════════════════════════════════════════════
-- 0047 · judgments, service and enforcement
-- ═══════════════════════════════════════════════════════════════════════════════
--
...
--
-- THE LIST IS GENERATED FROM THE UNION, IN ORDER, NOT TYPED. 148 actions.
-- ═══════════════════════════════════════════════════════════════════════════════
...
begin
  if not exists (
    ...
    raise exception '0047: audit_events_action_check was not created';
  end if;
  ...
  if admitted = 0 then
    raise exception '0047: the constraint does not look like an action list';
  end if;
  ...
  if missing is not null then
    raise exception '0047: declared but not admitted: %', missing;
  end if;

  raise notice '0047: audit vocabulary at 148 actions — verified against the declared union';
end $$;

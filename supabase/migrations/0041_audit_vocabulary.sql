-- ═══════════════════════════════════════════════════════════════════════════════
-- 0041 · AUDIT VOCABULARY · CLIENT DUE DILIGENCE (P0.3)
-- ═══════════════════════════════════════════════════════════════════════════════
--
...
--
-- THE LIST IS GENERATED FROM THE UNION, IN ORDER, NOT TYPED. 138 actions.
-- ═══════════════════════════════════════════════════════════════════════════════
...
begin
  if not exists (
    ...
    raise exception '0041: audit_events_action_check was not created';
  end if;
  ...
  if admitted = 0 then
    raise exception '0041: the constraint does not look like an action list';
  end if;
  ...
  if missing is not null then
    raise exception '0041: declared but not admitted: %', missing;
  end if;

  raise notice '0041: audit vocabulary at 138 actions — verified against the declared union';
end $$;
